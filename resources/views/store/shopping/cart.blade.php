    ...
    <div class="panel panel-brand">
        ...
        <table class="cart-content text-center">
            ...
            @foreach($cart->content() as $product)
                <tr>
                    <td><a class="inherit"
                           href="{{ route('StoreProductShow', App\Models\Product::findOrFail($product->id)->slug) }}">{{ $product->name }}</a>
                    </td>
                    <td>${{ $product->price }}</td>
                    <td>{{ $product->qty }}</td>
                    <td>
                        ...
                        <button type="submit" class="btn btn-default" form="form-{{ $product->id }}"
		...
		<span class="pull-right">
			<a href="{{ route('StoreCartCheckout') }}">
                <button class="btn btn-success">Proceed to checkout</button>
            </a>
			<a href="{{ route('StoreClearCart') }}">
