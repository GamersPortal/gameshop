@extends('admincp.master', ['title' => 'Category - ' . $category->slug])
  ...
  <div class="col-sm-12">
    <div class="panel panel-primary">
      ...
      <div class="panel-body">
        <div class="buttons">
          <a class="btn btn-default" href="{{ route('AdminCategoryEdit', $category->slug) }}" role="button">Edit
            category</a>
          <a class="btn btn-default" href="{{ route('AdminCategoryDelete', $category->slug) }}" role="button">Delete
            category</a>
        </div>
